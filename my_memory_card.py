...
#Список вопросов
questions = list()
questions.append(Question('В какой стране ты родился?', 'Россия', 'Англия', 'Китай', 'США'))
questions.append(Question('Когда родился Дамир?', "Рождество Христова", "1986", "1536", "333333333?"))
questions.append(Question("Привет?", "Что, я тебя не знаю!", "Вован?!", "Я тебя знаю?", "ПОКА!!!"))
